...
def create_demo_workflow(model_name: str):
    ...
    # The system_prompt for the coordinator is auto-generated by the workflow to include
    # the team manifest. However, providing a base prompt with the {{tools}}
    # placeholder is good practice.
