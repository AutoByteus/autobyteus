...
def create_demo_team(model_name: str):
    ...
    fact_checker_config = AgentConfig(
        ...
        system_prompt=(
            ...
            "You will be notified by 'ProjectManager' when a task is ready for you. When you receive a message, you must first use `get_task_plan_status` to find the task assigned to you.\n\n"
            "### Your Knowledge Base\n"
