# file: autobyteus/examples/agent_team/event_driven/run_software_engineering_team.py
"""
...
It showcases a system event-driven, automated communication protocol.
"""
import asyncio
import logging
import argparse
...
try:
    ...
    from autobyteus.tools import write_file, read_file, run_bash
...
def setup_file_logging() -> Path:
    ...
    log_file_path = log_dir / "software_engineering_team_event_driven_tui_app.log"
...
def create_code_review_team(
    ...
    tester_config = AgentConfig(
        ...
        tools=[run_bash, UpdateTaskStatus(), GetTaskPlanStatus(), SendMessageTo()],
        workspace=workspace
    )
...
async def main(args: argparse.Namespace, log_file: Path):
    ...
    print("Setting up software development team (SYSTEM EVENT-DRIVEN MODE)...")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run a software development agent team with a Textual TUI (System Event-Driven Mode).",
