# file: autobyteus/autobyteus/task_management/schemas/plan_definition.py
"""
...
class TaskPlanDefinition(BaseModel):
    ...
    tasks: List[TaskDefinition] = Field(..., description="The list of tasks that make up this plan.")

    @field_validator('tasks')
    def task_names_must_be_unique(cls, tasks: List[TaskDefinition]) -> List[TaskDefinition]:
