# file: autobyteus/autobyteus/agent/workflow/runtime/workflow_runtime.py
import asyncio
import logging
...
from ..streaming.workflow_event_notifier import WorkflowExternalEventNotifier
...
class WorkflowRuntime:
    ...
    async def submit_event(self, event: BaseWorkflowEvent):
        ...
        def _coro_factory():
            async def _enqueue():
                from ..events.workflow_events import ProcessRequestEvent
