# file: autobyteus/autobyteus/agent/workflow/streaming/workflow_event_notifier.py
import logging
from typing import Optional, Dict, Any, TYPE_CHECKING, Union

from ....events.event_emitter import EventEmitter
from ....events.event_types import EventType 
from ..phases.workflow_operational_phase import WorkflowOperationalPhase
from .workflow_stream_events import WorkflowStreamEvent, WorkflowStreamEventType
from ....agent.streaming.stream_events import StreamEvent
...
class WorkflowExternalEventNotifier(EventEmitter):
    ...
    def __init__(self, workflow_id: str, runtime_ref: 'WorkflowRuntime'):
        ...
        logger.debug(f"WorkflowExternalEventNotifier initialized for workflow '{workflow_id}'.")
