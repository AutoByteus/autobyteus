# src/source_code_tree/file_explorer/traversal_ignore_strategy/specific_folder_ignore_strategy.py

import os
from typing import List
import pathlib
from .traversal_ignore_strategy import TraversalIgnoreStrategy
