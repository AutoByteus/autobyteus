# file: autobyteus/tests/unit_tests/agent_team/shutdown_steps/test_agent_team_shutdown_step.py
import asyncio
import pytest
import logging
...
async def test_execute_success_with_running_agents(
    ...
    success = await team_shutdown_step.execute(agent_team_context)
