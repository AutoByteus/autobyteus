# file: autobyteus/tests/unit_tests/agent_team/bootstrap_steps/test_coordinator_initialization_step.py
import pytest
...
async def test_execute_success(
    ...
    success = await coord_init_step.execute(agent_team_context)
