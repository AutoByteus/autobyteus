...
def test_get_configured_model_identifier_success():
    ...
    expected_model = os.getenv("DEFAULT_IMAGE_GENERATION_MODEL")
    assert _get_configured_model_identifier("DEFAULT_IMAGE_GENERATION_MODEL", "fallback") == expected_model
...
async def test_generate_image_tool_execute():
    ...
    # Use a generic generation_config as the underlying model is not known.
    generation_config = {}
